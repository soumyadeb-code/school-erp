...
<?php $__env->startSection('page-title', 'Bill History'); ?>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-2">
                            <select id="year" class="form-select">
                                ...
                                <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acYear): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($acYear->year); ?>" <?php echo e($year == $acYear->year ? 'selected' : ''); ?>>
                                        <?php echo e($acYear->year); ?>
                        ...
                        <div class="col-md-2">
                            <select id="search_type" class="form-select">
                                <option value="receipt" <?php echo e($searchType == 'receipt' ? 'selected' : ''); ?>>Receipt No</option>
                                <option value="student" <?php echo e($searchType == 'student' ? 'selected' : ''); ?>>Student Name</option>
                                <option value="phone" <?php echo e($searchType == 'phone' ? 'selected' : ''); ?>>Phone</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <input type="text" id="query" class="form-control" placeholder="Search..." value="<?php echo e($query); ?>">
                        </div>
                        <div class="col-md-2">
                            <select id="bill_type" class="form-select">
                                <option value="">All Types</option>
                                <option value="admission" <?php echo e($billType == 'admission' ? 'selected' : ''); ?>>Admission</option>
                                <option value="monthly" <?php echo e($billType == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <select id="status" class="form-select">
                                ...
                                <option value="due" <?php echo e($status == 'due' ? 'selected' : ''); ?>>Due</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <input type="date" id="from_date" class="form-control" value="<?php echo e($fromDate); ?>" placeholder="From Date">
                        </div>
                        <div class="col-md-2">
                            <input type="date" id="to_date" class="form-control" value="<?php echo e($toDate); ?>" placeholder="To Date">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody id="billsTableBody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('students.receipt-view', $receipt->id)); ?>" target="_blank" class="btn btn-sm btn-info" title="View Receipt">
