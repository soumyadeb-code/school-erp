...
<div class="page">
    ...
    <!-- ORIGINAL COPY -->
    <div class="receipt">
        <div class="receipt-no">Receipt No.: <span class="dots-line" style="min-width:60px;">{{ $receipt->receipt_no }}</span></div>
        ...
        <div class="title">
            <h2>{{ $school->name }}</h2>
            <div class="small">
                Org. by <u>{{ $school->trust_name ?? 'Trust Name' }}</u><br>
    ...
    <span style="
        ...
        display:block;
    ">
        <span style="font-size:14px;">{{ $receipt->student->name }}</span>
    </span>

</div>
<br>
            <span class="label" style="font-weight:600;">Class:</span> 
            <span class="dots-line" style="min-width:80px;">{{ $receipt->student->schoolClass->class_name ?? '-' }}</span>
...
<span class="label" style=" font-weight:600;">For the:</span> 
        ...
        <div class="table-box">
            ...
            <div class="table-row">
                ...
                <div class="right">{{ number_format($receipt->total_amount, 0) }}</div>
            </div>

            <div class="table-row">
                <div class="left">Less</div>
                <div class="right">{{ number_format($receipt->discount, 0) }}</div>
            </div>
            ...
            <div class="table-row">
                ...
                <div class="right">{{ number_format($receipt->old_due_paid, 0) }}</div>
            </div>
            ...
            <div class="table-row">
                ...
                <div class="right">{{ number_format($receipt->due_amount, 0) }}</div>
            </div>
        </div>
    ...
    <div class="footer-left">
        <div>
            Paid <span class="dotted-line">{{ number_format($receipt->paid_amount, 0) }}</span>
        </div>
        <div style="margin-top: 10px;">
            Date <span class="dotted-line">{{ \Carbon\Carbon::parse($receipt->billing_date)->format('d-m-Y') }}</span>
        </div>
    </div>
