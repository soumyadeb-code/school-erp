...
<?php $__env->startSection('title', 'Bus Fees'); ?>

<?php $__env->startSection('page-title', 'Bus Fees Management'); ?>
...
<div class="modal fade" id="addFeeModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('school-admin.fees.bus.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="importModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('school-admin.fees.bus.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-3">
...
function loadBusFees(page = 1) {
    ...
    const url = '<?php echo e(route("school-admin.fees.bus.search")); ?>?' + 
        'page=' + page + 
...
function updateTable(data, page, perPage) {
    ...
    data.data.forEach((fee, index) => {
        ...
        const editUrl = '<?php echo e(route("school-admin.fees.bus.edit", ":id")); ?>'.replace(':id', fee.id);
        const deleteUrl = '<?php echo e(route("school-admin.fees.bus.destroy", ":id")); ?>'.replace(':id', fee.id);
...
function exportBusFees() {
    window.location.href = '<?php echo e(route("school-admin.fees.bus.export")); ?>';
}
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\AI\Laravel\Blackbox-school\resources\views/school-admin/fees/bus-fees.blade.php ENDPATH**/ ?>