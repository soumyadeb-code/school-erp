...
@section('title', 'Student Fee Price List')

@section('page-title', 'Fee Price List')
...
<ul class="nav nav-tabs mb-4">
    <li class="nav-item">
        <a class="nav-link active" href="{{ route('students.fee-price-list', $student->id) }}">
            <i class="fas fa-list me-1"></i> Fee Prices
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('students.payment-history', $student->id) }}">
...
<div class="card">
    <div class="card-header">
        <h5>Fee Price List - {{ $student->name }} ({{ $student->student_id }})</h5>
    </div>
    <div class="card-body">
        <!-- Student Info -->
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <table class="table table-sm">
                    <tr>
                        <th>Old Due:</th>
                        <td class="text-danger">₹{{ number_format($oldDue, 2) }}</td>
                    </tr>
                    <tr>
                        <th>Advance:</th>
                        <td class="text-success">₹{{ number_format($advance, 2) }}</td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>₹{{ number_format($admissionFeeAmount, 2) }}</td>
                        <td>
                            <a href="{{ route('students.billing', $student->id) }}" class="btn btn-primary btn-sm">
                    ...
                    <tr>
                        ...
                        <td>₹{{ number_format($registrationFeeAmount, 2) }}</td>
                        <td>
                            <a href="{{ route('students.billing', $student->id) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-file-invoice me-1"></i> Generate Bill
                            </a>
                    ...
                    <tr>
                        ...
                        <td>₹{{ number_format($classFeeAmount, 2) }}</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>₹{{ number_format($busFeeAmount, 2) }}</td>
                        <td>
                            <a href="{{ route('students.monthly-bill', $student->id) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-file-invoice me-1"></i> Generate Bill
                            </a>
                    ...
                    <tr>
                        ...
                        <td>₹{{ number_format($booksetPriceAmount, 2) }}</td>
                        <td>
                            <a href="{{ route('students.monthly-bill', $student->id) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-file-invoice me-1"></i> Generate Bill
                            </a>
                ...
                <tfoot>
                    <tr class="table-success">
                        ...
                        <td><strong>₹{{ number_format($admissionFeeAmount + $registrationFeeAmount + $booksetPriceAmount, 2) }}</strong></td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="mt-3">
            <a href="{{ route('students.fee-collection') }}" class="btn btn-secondary">
