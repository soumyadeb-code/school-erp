                            ...
                            <tbody id="billsTableBody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <button class="btn btn-sm btn-secondary" disabled title="Receipt view not available">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                        @endif
                                    </td>
            ...
            success: function(response) {
                ...
                if (response.receipts.length > 0) {
                    response.receipts.forEach(function(receipt) {
                        ...
                        let actionBtn = '';
                        if (receipt.bill_type === 'monthly') {
                            actionBtn = '<a href="/students/receipt-view/' + receipt.id + '" class="btn btn-sm btn-info" title="View Receipt"><i class="fas fa-eye"></i></a>';
                        } else {
                            actionBtn = '<button class="btn btn-sm btn-secondary" disabled title="Receipt view not available"><i class="fas fa-eye"></i></button>';
                        }
