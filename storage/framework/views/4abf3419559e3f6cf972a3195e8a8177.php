...
<?php $__env->startSection('title', 'Registration & Promotion'); ?>

<?php $__env->startSection('page-title', 'Registration & Promotion'); ?>
    ...
    <?php else: ?>
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $unregisteredStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <a href="#" class="student-id-link"><?php echo e($student->student_id); ?></a>
                        </td>
                        ...
                        <td>
                            <a href="<?php echo e(route('students.registration-billing', $student->id)); ?>" class="btn-register-promote">
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('students.show', $student->id)); ?>" class="btn-view" title="View">
