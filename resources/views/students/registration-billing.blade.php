...
@section('title', 'Registration Billing')

@section('page-title', 'Registration Billing')
...
<div class="card">
    <div class="card-header">
        <h5>Registration Billing - {{ $student->name }} ({{ $student->student_id }})</h5>
    </div>
    <div class="card-body">
        <form id="bill-form" action="{{ route('students.registration-billing.process', $student->id) }}" method="POST">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" id="feeValue" value="{{ $registrationFee ? $registrationFee->amount : 0 }}">
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('students.registration') }}" class="btn btn-secondary mt-3">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
