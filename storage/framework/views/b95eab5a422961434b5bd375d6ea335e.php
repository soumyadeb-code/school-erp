...
<?php $__env->startSection('title', 'Registration Fees Setup'); ?>

<?php $__env->startSection('page-title', 'Registration Fees Setup'); ?>
...
<div class="row">
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('school-admin.fees.registration.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($fee->registration_start_date): ?>
                                        <?php echo e(\Carbon\Carbon::parse($fee->registration_start_date)->format('d M Y')); ?>
                                ...
                                <td>
                                    <a href="<?php echo e(route('school-admin.fees.registration.edit', $fee->id)); ?>" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form method="POST" action="<?php echo e(route('school-admin.fees.registration.destroy', $fee->id)); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\AI\Laravel\Blackbox-school\resources\views/school-admin/fees/registration-fees.blade.php ENDPATH**/ ?>